...
Packages installed :
     ...
     Google apiclient.discovery: It allows interaction with the youtube data API and enabling the retrieval of video-related data.
     Streamlit:It is employed as the web application framework for this project.It is a user-friendly interface for easy interaction with the application.
     Psycopg2:It is utilized to establish a connection and perform operations on a PostgreSQL database.It facilitates the migration of data from MongoDB to PostgreSQL for subsequent analysis.
     Pandas:It is used for data manipulation and analysis.It aids in organizing and structuring the collected data in a convenient format(ie. table format).
     Pymongo:It is employed to interact with MongoDB, it is a NOSQL database.It enables the storage of unstructured data extracted from youtube.
